#!/usr/bin/env bash
# One-variable Room run: stock training with terminal opacity floor 0.8.
set -euo pipefail
...
CHECKPOINT="$RUNS/opacity08__room/point_cloud/iteration_30000/point_cloud_state_dict.pt"
