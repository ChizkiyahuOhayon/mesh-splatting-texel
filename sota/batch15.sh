#!/usr/bin/env bash
# Matched Bicycle control: published terminal opacity floor 0.9999.
set -euo pipefail
...
CHECKPOINT="$RUNS/stock__bicycle/point_cloud/iteration_30000/point_cloud_state_dict.pt"
...
if value != 0.9999:
    raise SystemExit(f"checkpoint opacity_floor is {value}, expected 0.9999")
